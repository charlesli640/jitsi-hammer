...
public class NewJingleUtils
{
            ...
            DynamicPayloadTypeRegistry ptRegistry)
    {
        ...
        List<NewParameterPacketExtension> params = payloadType.getParameters();
        Map<String, String> paramsMap = new HashMap<String, String>();
        Map<String, String> advancedMap = new HashMap<String, String>();

        for(NewParameterPacketExtension param : params)
        {
    ...
    public static List<RTPExtension> extractRTPExtensions(
            NewRtpDescriptionPacketExtension desc,
            DynamicRTPExtensionsRegistry  extMap)
    {
        ...
        List<NewRTPHdrExtPacketExtension> extmapList = desc.getExtmapList();

        for (NewRTPHdrExtPacketExtension extmap : extmapList)
        {
     ...
     */
    public static NewContentPacketExtension createDescription(
            CreatorEnum                  creator,
            String                       contentName,
            SendersEnum                  senders,
        ...
        if (rtpExtensions != null && rtpExtensions.size() > 0)
        {
            for (RTPExtension extension : rtpExtensions)
            {
                ...
                SendersEnum sendersEnum = getSenders(extDirection,
                        false);
                NewRTPHdrExtPacketExtension ext = new NewRTPHdrExtPacketExtension();
     ...
     */
    public static NewPayloadTypePacketExtension formatToPayloadType(
            MediaFormat format,
            DynamicPayloadTypeRegistry ptRegistry)
    {
        NewPayloadTypePacketExtension ptExt = new NewPayloadTypePacketExtension();
        ...
        {
            NewParameterPacketExtension ext = new NewParameterPacketExtension();
